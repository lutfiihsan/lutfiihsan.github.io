...
function openPost(slug) {
    ...
    window.location.href = `/blog/post/?slug=${encodeURIComponent(slug)}`;
}
...
async function initPostPage() {
    ...
    if (!slug) {
        container.innerHTML = `<div style="text-align:center; padding:6rem;"><h2>Artikel tidak ditemukan</h2> <a href="/blog/">← Kembali ke Blog</a></div>`;
        return;
    }
